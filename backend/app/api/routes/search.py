...
async def ai_chat_original(
    ...
    if prompt:
        ...
        system_prompt = f"""你是一个友善、专业的智能知识助手，名?知枢星图AI助手"?
...
2. **有据可依**：如果引用了知识库内容，请注明来?

3. **诚实可靠**：如果知识库没有相关信息，诚实地告知用户

4. **友好亲切**：用友好、专业的方式与用户交?



## 限制

- 不知道的问题要诚实说"我不知道"?知识库中没有相关信息"
...
async def vector_search(
    ...
    try:
        ...
        return Response(
            ...
            message=sanitize_error(e, "向量搜索错误"),
...
async def batch_vector_search(
    ...
    try:
        ...
        return Response(
            ...
            message=sanitize_error(e, "批量向量搜索错误"),
...
async def rebuild_vector_index(
    ...
    try:
        ...
        return Response(
            ...
            message=sanitize_error(e, "重建索引失败"),
...
async def rebuild_bm25_index(
    ...
    try:
        ...
        return Response(
            ...
            message=sanitize_error(e, "重建BM25索引失败"),
